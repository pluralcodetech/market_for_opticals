...
import SaveCart from "../../../components/superAdmin/market/cart/save";
import Save from "../../../components/superAdmin/market/saved/save";
import { BiSearchAlt } from "react-icons/bi";
import { HiCube } from "react-icons/hi";
import Cart from "../../../components/superAdmin/market/navbar/cart";
import Cat from "../../../components/superAdmin/market/navbar/cat";
import Wishlist from "../../../components/superAdmin/market/navbar/wishlist";
import Product from "../../../components/superAdmin/market/product/product";
...
function MarketplaceAdmin() {
  ...
  return (
    <Layout>
      <div className="p-8 bg-[#FDF0DC] h-fit">
        <div className="flex">
