...
function UpdateProduct() {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        ...
        seteye_size(res.data.product_sizes);
        setimage(res.data.image_url[0].image_url);
        const im = document.getElementById("preview");
        im.src = res.data.image_url[0].image_url;
        //console.log(res.data.image_url[0].image_url);
        setbrand(res.data.brand);
        setdescription(res.data.product_details);
        setspecifications(res.data.product_specifications);
  ...
  const submitProduct = (e) => {
    ...
    axios
      .post(`${api_url}/update_product`, formData, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token")}`,
        },
      })
  ...
  return (
    <Layout>
      <div className="bg-white w-full md:w-[60%] mx-auto h-fit overflow-y-auto mx-auto  border shadow rounded-lg p-6 mt-8">
        ...
        <form action="" onSubmit={(e) => submitProduct(e)}>
          ...
          <div className="mb-4">
            ...
            {brands.length > 0 ? (
              ...
              <select className="bg-gray-200 appearance-none rounded w-full py-3 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-amber-500">
          ...
          {isLoading ? (
            ...
            <button
              type="submit"
              className="w-[60%] md:w-[40%] mb-4 bg-amber-500 hover:bg-amber-400 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            >
              Update Product
            </button>
          )}
